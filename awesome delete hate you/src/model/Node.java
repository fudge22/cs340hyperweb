...
public class Node implements NodeInterface {
	...
	public static void removeNode() {
		...
		debugInfo("up state " + randomDeleteNode.getUpState());
		...
		if (randomDeleteNode.getUpState().equals(Deletable.getSingleton())) {
			randomDeleteNode.disconnect();
			disconnectID = randomDeleteNode.getWebID();
		}
		else {
			Node disconnectPoint = randomStartNode.getUpState().findEdgeNodeFrom(randomStartNode);
			disconnectID = disconnectPoint.getWebID();
	...
	public void disconnect() {
		...
		for (WebID neighborID : this.neighbors) {
			System.out.println("neighbors of  " + neighborID + ": " + getNode(neighborID).neighbors);
		}
...
//		}
	...
	public void accept(BroadcastVisitor visitor){
		visitor.visit(this);
	}
