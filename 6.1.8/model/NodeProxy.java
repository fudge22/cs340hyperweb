...
//				SerializeHelp.release();
    ...
    public void removeNeighborDown(WebID p0){
    	
    	String[] parameterTypeNames = new String[1];
        parameterTypeNames[0] = "model.WebID";
        Object[] actualParameters = new Object[1];
        actualParameters[0] = p0;
        Command command = new Command(globalObjectId.getLocalObjectId(), "model.Node", "removeNeighborDown", parameterTypeNames, actualParameters, false);
        PeerCommunicator.getSingleton().sendASynchronous(globalObjectId, command);
    ...
    public void addNeighborDown(WebID p0){
    	
    	String[] parameterTypeNames = new String[1];
        parameterTypeNames[0] = "model.WebID";
        Object[] actualParameters = new Object[1];
        actualParameters[0] = p0;
        Command command = new Command(globalObjectId.getLocalObjectId(), "model.Node", "addNeighborID", parameterTypeNames, actualParameters, false);
        PeerCommunicator.getSingleton().sendASynchronous(globalObjectId, command);
	...
	private void addDoubleNeighborDown(WebID webID2) {
        ...
        parameterTypeNames[0] = "model.WebID";
        Object[] actualParameters = new Object[1];
        actualParameters[0] = webID2;
        Command command = new Command(globalObjectId.getLocalObjectId(), "model.Node", "addDoubleNeighborDown", parameterTypeNames, actualParameters, false);
        PeerCommunicator.getSingleton().sendASynchronous(globalObjectId, command);
	...
	private void removeDoubleNeighborDown(WebID webID2) {
        ...
        Object[] actualParameters = new Object[1];
        actualParameters[0] = webID2;
        Command command = new Command(globalObjectId.getLocalObjectId(), "model.Node", "removeDoubleNeighborDown", parameterTypeNames, actualParameters, false);
        PeerCommunicator.getSingleton().sendASynchronous(globalObjectId, command);
