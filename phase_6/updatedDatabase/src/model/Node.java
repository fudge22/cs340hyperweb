...
public class Node implements NodeInterface {
	...
	public void setFoldState(int foldStateInt) {
		switch (foldStateInt) {
		case 0:
			this.foldState = StableFold.getSingleton();
			break;
	...
	public void setDownState(int downStateInt) {
		switch (downStateInt) {
		case 0:
			this.downState = Insertable.getSingleton();
			break;
	...
	public void setUpState(int upStateInt) {
		switch (upStateInt) {
		case 0:
			this.upState = Deletable.getSingleton();
			break;
	...
	public void setCurrentChild(WebID currentChild) {
		this.currentChild = currentChild;
	}
	
	public Set<WebID> getNeighborDownSet() {
		return neighborDown;
	}

	public void setNeighborDownSet(Set<WebID> neighborDown) {
		this.neighborDown = neighborDown;
	}
	
	public Set<WebID> getDoubleNeighborDownSet() {
		return doubleNeighborDown;
	}

	public void setDoubleNeighborDownSet(Set<WebID> doubleNeighborDown) {
		this.doubleNeighborDown = doubleNeighborDown;
	}
	
	public Set<WebID> getSelfUpSet() {
		return selfUp;
	}

	public void setSelfUpSet(Set<WebID> selfUp) {
		this.selfUp = selfUp;
	}
	
	public Set<WebID> getSelfDownSet() {
		return selfDown;
	}

	public void setSelfDownSet(Set<WebID> selfDown) {
		this.selfDown = selfDown;
	}
	
	public Set<WebID> getNeighborUpSet() {
		return neighborUp;
	}

	public void setNeighborUpSet(Set<WebID> neighborUp) {
		this.neighborUp = neighborUp;
	}
	
	public Set<WebID> getDoubleNeighborUpSet() {
		return doubleNeighborUp;
	}

	public void setDoubleNeighborUpSet(Set<WebID> doubleNeighborUp) {
		this.doubleNeighborUp = doubleNeighborUp;
	}
	
	public Set<WebID> getLowerNeighborsSet() {
		return lowerNeighbors;
	}

	public void setLowerNeighborsSet(Set<WebID> lowerNeighbors) {
		this.lowerNeighbors = lowerNeighbors;
	}
	
	public Set<WebID> getHigherNeighborsSet() {
		return lowerNeighbors;
	}

	public void setHigherNeighborsSet(Set<WebID> higherNeighbors) {
		this.higherNeighbors = higherNeighbors;
	}
