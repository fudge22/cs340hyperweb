...
//	}
	...
	public void testSend() {
		...
		Visitor newVisitor = new SendVisitor(3);
		newVisitor.visit(Node.getNode(new WebID(0)), new Parameters());
		
		newVisitor = new SendVisitor(5);
		newVisitor.visit(Node.getNode(new WebID(10)), new Parameters());
		
		newVisitor = new SendVisitor(15);
		newVisitor.visit(Node.getNode(new WebID(0)), new Parameters());
	}
